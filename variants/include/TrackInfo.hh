...
public:
  ...
  void SetTransmissionLogged(G4bool value = true) { fTransmissionLogged = value; }
  G4bool TransmissionLogged() const { return fTransmissionLogged; }

private:
  G4bool fHasScattered;
  G4bool fTransmissionLogged;
};
